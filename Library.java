...
public class Library {
	...
	public static void main (String args[]) {
		...
		//should generate prompt because  already checked out 
		lib.checkout("Goofy", "March 28, 2012", "QA76.6.W3275");
		
		// Test to check if call number is not in the library 
		lib.returned("QA76.6.W3276"); 
		
		// should generate prompt because  already returned
		lib.returned("QA76.6.W3275"); 
		
		//It should print out "Found it!" because the book is in the library
		if (lib.findBook(new ReferenceBook ("Samuel A. Rebelsky",
				"Experiments in Java", 
				"0201612674", "64.2 R25ex", "Iowa Room")) != null) {
			System.out.println("Found it!");
		} else {
			System.out.println("I can't find it!");
		}
		
		/*It should print out "I can't find it" because the book is not
		in the library*/
		if (lib.findBook(new ReferenceBook ("Samuel A. Rebelsky",
				"Experiments in Java", 
				"0201612674", "64.2 R25ex ", "Iowa Room")) != null) {
		...
		ReferenceBook a = new ReferenceBook ("Henry M. Walker", 
				"Problems for Computer Solution using BASIC",
				"0-87626-717-7", "AA76.73.B3W335", "Iowa Room");
		
		CirculatingBook b = new CirculatingBook ("Henry M. Walker",
			    "The Limits of Computing",
			    "0-7637-2552-8", "QA76.W185");
		
		
		if(a.compareTo(b) < 0 ) {
			System.out.println("AA is before QA");
		}else {
			System.out.println("AA is not before QA");
		}
		
		//Test compareTo() method
		ReferenceBook c = new ReferenceBook ("Henry M. Walker", 
				"Problems for Computer Solution using BASIC",
				"0-87626-717-7", "QA76.73.B3W335", "Iowa Room");
		
		CirculatingBook d = new CirculatingBook ("Henry M. Walker",
			    "The Limits of Computing",
			    "0-7637-2552-8", "AA76.W185");
		...
		//Test compareTo() method
		ReferenceBook e = new ReferenceBook ("Henry M. Walker", 
				"Problems for Computer Solution using BASIC",
				"0-87626-717-7", "AA76.73.B3W335", "Iowa Room");
		
		CirculatingBook f = new CirculatingBook ("Henry M. Walker",
			    "The Limits of Computing",
			    "0-7637-2552-8", "AA76.W185");
		
		
		if(e.compareTo(f) == 0 ) {
			System.out.println("AA is equal to AA");
		}else {
			System.out.println("AA is not equal to AA");
		}
		
		//Test compareTo() method
		ReferenceBook g = new ReferenceBook ("Henry M. Walker", 
				"Problems for Computer Solution using BASIC",
				"0-87626-717-7", "AA76.W185", "Iowa Room");
		
		CirculatingBook h = new CirculatingBook ("Henry M. Walker",
			    "The Limits of Computing",
			    "0-7637-2552-8", "AA76.W185");
